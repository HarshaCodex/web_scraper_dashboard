...
from web_scraper_dashboard.constants import job_listing_field, company_field, title_field, link_field, main_url, url
...
def extract_jobs(job_listing):
    ...
    return {"company": company_name, "title": title, "link": job_link}
